    ...
    >
      ...
      {(isGameLost || isGameWon) && (
        <div className="mt-5 sm:mt-6 columns-2 dark:text-white">
          ...
          <button
            type="button"
            className="mt-2 w-full rounded-md text-center border-white shadow-sm px-4 py-2 bg-black text-base font-medium text-white hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black dark:border-white sm:text-sm"
            onClick={() => {
