...
export const WIN_MESSAGES = ['solid', 'nice', 'root@drudgle:~$']
...
export const HARD_MODE = 'god mode'
export const EASY_MODE = 'n00b mode'
export const FOCUS_MODE = 'hacker interface'
export const VIS_MODE = 'n00b interface'
