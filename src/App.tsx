  ...
  return (
    <div className="fixed grid grid-rows-[1fr_auto] grid-cols-1 bg-black top-0 left-0 w-full h-full font-mono font-extrabold">
      <div className="w-full flex flex-col justify-between overflow-y-auto mx-auto sm:px-6 lg:px-8">
        <div className="fixed sticky flex-shrink-0 top-0 h-12 bg-black flex-grow-0 flex gap-1 w-full max-w-prose mx-auto items-center px-4 z-[1000]">
          <AlertContainer />
        ...
        {isHardMode ? (
          ...
          <PuzzleIcon
            className="h-6 w-6 mr-2 cursor-pointer stroke-slate-700 dark:stroke-slate-700"
            onClick={() => {
              handleHardMode(!isHardMode)
            }}
          />
