    ...
    >
      ...
      {(isGameLost || isGameWon) && (
        <div className="mt-5 sm:mt-6 columns-2 dark:text-white">
          <div>
            <h5>{NEW_WORD_TEXT} <a href={`https://www.merriam-webster.com/dictionary/${solution}](https://www.merriam-webster.com/dictionary/${solution}`} target="_blank" rel="noreferrer">Go to definition</a> </h5>
            <Countdown
