    ...
    >
      ...
      {(isGameLost || isGameWon) && (
        <div className="mt-5 sm:mt-6 columns-2 dark:text-white">
          <div>
            <h5><a href="https://wordler.space" className="underline font-bold">return</a> {NEW_WORD_TEXT} <a href={`https://urbandictionary.com/${solutionDefinition}`} target="_blank" rel="noreferrer" className="underline font-bold">{solutionDefinition}</a></h5>
            <Countdown
