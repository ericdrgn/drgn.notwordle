  ...
  const classes = classnames(
    'w-14 h-14 border-solid border-2 flex items-center justify-center mx-0.5 text-4xl font-bold rounded text-white dark:text-white',
    {
      ...
      'correct shadowed bg-black text-green-500 border-black dark:bg-green-500 dark:text-white dark:border-green-500':
        status === 'correct',
      'present shadowed dark:border-dashed dark:border-double dark:border-2 bg-black text-yellow-500 border-black dark:bg-yellow-500 dark:text-white dark:border-white':
        status === 'present',
